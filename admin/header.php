...
<li class="active"><a href="index.php"><i class="glyphicon glyphicon-home"></i> Halaman Utama</a></li>
...
<li><p class="navbar-text">Selamat Datang, <b> <?php echo $_SESSION['username']; ?></li>
</ul>
</div>
</div>
</nav>
